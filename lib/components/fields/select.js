  ...
  ready: function() {
    ...
    var options = this.inForm()?clone(this.$parent.options.select2Options):{};
      ...
      if (this.containerClass) {
        el.data('select2').$container.addClass("container-" + this.containerClass);
        el.data('select2').$dropdown.addClass("dropdown-" + this.containerClass);
      }


      this.$watch('value', function(value, oldVal) {
